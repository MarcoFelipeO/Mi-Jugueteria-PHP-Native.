    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#about">Documentos en linea</a></li>
          <li><a class="nav-link scrollto" href="#services">Reserva de hora</a></li>
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li>Descripcion de documento requerido</li>
          </ol>
        </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="portfolio-description">
              ...
              <p>
                ...
                Se recomienda llevar tres (3) copias impresas del finiquito (es requerida la firma del empleador aunque sea en digital/escaneada).
                Certificado de cotizaciones previsionales al día.
                Puedes simular los montos de tu finiquito en el siguiente link de la Dirección del Trabajo. Click Aquí
                Si tienes varios finiquitos y deseas realizar una sola operación, escríbenos a convenios@notarioexpress.cl para asistirte.
                Se debe presentar de manera impresa las ultimas tres liquidaciones de sueldo del trabajador
                IMPORTANTE: no se realiza custodia de valores.
              </p>
            </div>
            <div class="portfolio-description">
              <h2>Anexo de Finiquito</h2>
              <p>
                Es la modificación al acuerdo formal entre el trabajador y el empleador, donde se estipulan las condiciones, por ejemplo Bono pendiente, gratificación pendiente, etc.
                ...
                Traer tres (3) copias del anexo de Finiquito impresas.
              </p>
            </div>
