$(document).ready(function(){
	$('#Btn-Updt-Zone').click(function(){
    URL = $("#UrlSite").val();
    URL_Process = URL+"zone/update_tourist_zone/";
    datos = $('#Form-Updt-Tourist-Zone').serialize();

    const process__response = document.querySelectorAll('#Btn-Updt-Zone');
    ...
    const btnPrincipal = document.querySelector('#Btn-Updt-Zone');
        ...
        if(jsonData.error == "1")
        {
          let Mensaje = `           
          	<div class="alert alert-danger alert-left-bordered border-danger alert-dismissible d-flex align-items-center p-md-4 mb-2 fade show" role="alert">
	            ...
	            <p class="mb-0">
                <strong>¡Oops!</strong> Alguno de los datos son incorrectos, verificar los campos (Nombre, Enlace de google maps, Estatus de la zona).
              </p>
	            <p class="mb-0">
