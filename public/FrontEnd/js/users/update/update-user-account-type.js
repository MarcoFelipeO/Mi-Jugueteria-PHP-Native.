$(document).ready(function(){
	$('#Btn-Updt-Account-Type').click(function(){
    URL = $("#UrlSite").val();
    URL_Process = URL+"users/update_user_account_type/";
    datos = $('#Form-Updt-Account-Type').serialize();

    const process__response = document.querySelectorAll('#Btn-Updt-Account-Type');
    ...
    const btnPrincipal = document.querySelector('#Btn-Updt-Account-Type');
        ...
        if(jsonData.error == "1")
        {
          let Mensaje = `           
          	<div class="alert alert-danger alert-left-bordered border-danger alert-dismissible d-flex align-items-center p-md-4 mb-2 fade show" role="alert">
	            ...
	            <p class="mb-0">
                <strong>¡Oops!</strong> Alguno de los datos son incorrectos, verificar los campos (Tipo de cuenta o Usuario seleccionado).
              </p>
	            <p class="mb-0">
