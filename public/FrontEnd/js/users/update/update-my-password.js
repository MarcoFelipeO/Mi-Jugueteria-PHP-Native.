$(document).ready(function(){
	$('#Btn-Updt-My-Password').click(function(){
    URL = $("#UrlSite").val();
    URL_Process = URL+"users/update_my_password/";
    datos = $('#Form-Updt-My-Password').serialize();

    const process__response = document.querySelectorAll('#Btn-Updt-My-Password');
    ...
    const btnPrincipal = document.querySelector('#Btn-Updt-My-Password');
        ...
        if(jsonData.error == "1")
        {
          let Mensaje = `           
          	<div class="alert alert-danger alert-left-bordered border-danger alert-dismissible d-flex align-items-center p-md-4 mb-2 fade show" role="alert">
	            ...
	            <p class="mb-0">
                <strong>¡Oops!</strong> Alguno de los datos son incorrectos, verificar los campos (Password).
              </p>
	            <p class="mb-0">
